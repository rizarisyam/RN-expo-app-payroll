    ...
    return (
        <>
            <ScrollView >
                            ...
                            <Box bgColor={'#FFFFFF'} rounded={'md'} p={5} shadow={'4'}>
                                <VStack space={3}>
                                    <HStack space={2}>
                                        ...
                                        <Text fontSize={'md'} fontWeight={'bold'}>Cuti Tahunan</Text>
                                    </HStack>
                                    <HStack>
                        ...
                        <Box bgColor={'#FFFFFF'} rounded={'md'} p={5} shadow={'4'}>
                            <VStack space={3}>
                                <HStack space={2}>
                                    ...
                                    <Text fontSize={'md'}>|</Text>
                                    <Text fontSize={'md'} fontWeight={'bold'}>Cuti Melahirkan</Text>
                                </HStack>
                                <HStack>
                        ...
                        <Box bgColor={'#FFFFFF'} rounded={'md'} p={5} shadow={'4'}>
                            <VStack space={3}>
                                <HStack space={2}>
                                    ...
                                    <Text fontSize={'md'}>|</Text>
                                    <Text fontSize={'md'} fontWeight={'bold'}>Khusus/Penting</Text>
                                </HStack>
                                <HStack>
                ...
                {route.name == 'LeaveScreen' && (
                    <Fab
                        onPress={() => navigation.navigate('Addition', { screen: 'ApplyForLeaveScreen' })}
